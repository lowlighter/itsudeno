...
/** Module call */
export interface mcall<raw, args, past extends result, result> {
  /** Name */
  _?: string
...
export interface applied<raw, args, past extends result, result> extends before<raw, args, past> {
  /** Changes list */
  changes: diff
...
/** Module outcome */
export interface outcome<raw, args, past extends result, result> extends applied<raw, args, past, result> {
  /** Name */
  name: string
