 ...
 */
export abstract class Module<raw, args, past extends result, result> extends Common<definition> {
  /** Collect past state */
  ...
  private static outcome<raw, args, past extends result, result>({name, meta, args}: {name: string, meta: meta, args: args}): outcome<raw, args, past, result> {
