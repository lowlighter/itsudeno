...
export abstract class ConsoleReporter extends Reporter<raw, args> {
  ...
  /** Definition */
  static readonly definition = {"description":"Console reporter\nOutputs module outcome through console\n","args":{"report":{"description":"Report options","type":{"changes":{"description":"Report changes","type":"boolean","default":true},"result":{"description":"Report results","type":"boolean","default":true},"skipped":{"description":"Report skipped executions","type":"boolean","default":true},"success":{"description":"Report successful executions","type":"boolean","default":true}}}},"maintainers":["lowlighter"]}
