...
export class HttpRequestModule extends Module<raw, args, past, result> {
  ...
  static readonly definition = {
    ...
    "args": {
      ...
      "status": {"description": "Allowed reponse status codes", "type": "number[]", "default": [200]},
    },
    "past": null,
    "result": {
      "url": {"description": "Response URL", "type": "string"},
      "redirected": {"description": "Whether response URL has been redirected", "type": "boolean"},
      ...
      "text": {"description": "Response text", "type": "string"},
      "data": {"description": "Response data (if JSON parseable)", "type": "unknown{}", "optional": true},
    },
...
export interface result {
  /** Response URL */
  url: string
  /** Whether response URL has been redirected */
  redirected: boolean
  /** Response status */
  status: {
  ...
  /** Response text */
  text: string
  /** Response data (if JSON parseable) */
