...
export abstract class LocalVault extends Vault<raw, args> {
  ...
  /** Definition */
  static readonly definition = {"description":"Local vault\nStores secrets locally and encrypt them with AES cipher\n","args":{"key":{"description":"AES cipher key","type":"string","match":["length(16)","length(24)","length(32)"],"default":"${it.settings.vaults.local.key}"},"path":{"description":"Vault file path","type":"string","match":["filepath"],"default":"${it.settings.vaults.local.path}"}},"maintainers":["lowlighter"]}
