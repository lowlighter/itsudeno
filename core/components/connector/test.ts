// Imports
import { assert, assertMatch, assertObjectMatch, assertRejects, assertStrictEquals, ItsudenoError, Suite, TestTracer } from "../../testing/mod.ts"
...
await new Suite(import.meta.url).group("connector", async test => {
	...
	test("#bundle()", async () => {
		for (
			const [payload, expected] of [['console.log("Welcome to Itsudeno 🍣!")', {success: true, stdout: "Welcome to Itsudeno 🍣!\n"}], ['import "@it/core/testing/welcome.ts"', {
				success: true,
				stdout: "Welcome to Itsudeno 🍣!\n",
