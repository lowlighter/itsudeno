...
async function _check(
	schema: Record<string, input> | null,
	entries: Record<string, unknown> | null,
	{name, tracer, context, result, errors, path}: {name: string, tracer: Tracer | null, context?: Context, result: Record<string, unknown>, errors: string[], path: string},
) {
	// Without arguments
